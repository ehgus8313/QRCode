...
public class ContactFragment extends Fragment implements View.OnClickListener {
    ...
    EditText edtValue;
    ImageView qrImage;
    String inputValue, name, nickname, phone, email, company, page, address, birth;
    private Bitmap bitmap;
    private QRGEncoder qrgEncoder;
    private Animation fab_open, fab_close;
    private Boolean isFabOpen = false;
    private FloatingActionButton fab, fabsave, fabshare;
    private EditText nameText,nicknameText,phoneText,emailText,companyText,pageText,addressText;
    private Spinner yearspinner,monthspinner,dayspinner;
    private ArrayAdapter yearadapter,monthadapter,dayadapter;
    ...
    public void onActivityCreated(Bundle b) {
        ...
        nicknameText = (EditText) getView().findViewById(R.id.nicknameText);
        phoneText = (EditText) getView().findViewById(R.id.phoneText);
        emailText = (EditText) getView().findViewById(R.id.EmailText);
        companyText = (EditText) getView().findViewById(R.id.CompanyText);
        pageText = (EditText) getView().findViewById(R.id.pageText);
        addressText = (EditText) getView().findViewById(R.id.addressText);
        yearadapter = ArrayAdapter.createFromResource(getActivity(), R.array.year, android.R.layout.simple_spinner_dropdown_item);
        yearspinner.setAdapter(yearadapter);
        monthadapter = ArrayAdapter.createFromResource(getActivity(), R.array.month, android.R.layout.simple_spinner_dropdown_item);
        ...
        final EditText PasswordText = (EditText) getView().findViewById(R.id.majorText);
        ...
        Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                page = pageText.getText().toString();
                address = addressText.getText().toString();
                birth = yearspinner.getSelectedItem().toString()+monthspinner.getSelectedItem().toString()+dayspinner.getSelectedItem().toString();

                if (name.equals("")||nickname.equals("")||phone.equals("")||email.equals("")||company.equals("")||page.equals("")||address.equals("")||yearspinner.equals("")||monthspinner.equals("")||dayspinner.equals("")) {
                    Snackbar.make(v, "빈 칸 없이 입력해주세요.", Snackbar.LENGTH_LONG)
                            .setAction("Action", null).show();
                    return;
                }
                inputValue = "MECARD:N:" + name + ";" + "TEL:" + phone + ";" + "EMAIL:" + email + ";"
                + "NOTE:" + company + ";" + "BDAY:" + birth + ";" + "ADR:" + address + ";"
                + "URL:" + page + ";" + "NICKNAME:" + nickname;
...
//                Toast.makeText(this, "Floating Action Button", Toast.LENGTH_SHORT).show();
            ...
            case R.id.fabsave:
                ...
                String result;
                try {
                    save = QRGSaver.save(savePath, nameText.getText().toString().trim(), bitmap, QRGContents.ImageType.IMAGE_JPEG);
...
//                    Log.d(TAG, savePath+SSIDText.getText().toString().trim()+".jpg");
            ...
            case R.id.fabshare:
                ...
                try {
//                    Bitmap bitmap1 =getBitmapFromView(qrImage);
