...
public class WIFIFragment extends Fragment implements View.OnClickListener {
    ...
    EditText edtValue;
    ImageView qrImage;
    String inputValue, Authentication, SSID, Password;
    ...
    public void onActivityCreated(Bundle b) {
        ...
        spinner = (Spinner) getView().findViewById(R.id.idSpinner);
        Button Button = (Button) getView().findViewById(R.id.Button);
        adapter = ArrayAdapter.createFromResource(getActivity(), R.array.wifi, android.R.layout.simple_spinner_dropdown_item);
        spinner.setAdapter(adapter);
        SSIDText = (EditText) getView().findViewById(R.id.nameText);
        PasswordText = (EditText) getView().findViewById(R.id.majorText);
        ...
        Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    Authentication = spinner.getSelectedItem().toString();
                    SSID = SSIDText.getText().toString();
                    Password = PasswordText.getText().toString();
                    if (Authentication.equals("None")) {
                        inputValue = "WIFI:S:" + SSID + ";" + "P:" + Password + ";;";
                    } else if (Authentication.equals("WEP")) {
                        inputValue = "WIFI:T:WEP;S:" + SSID + ";" + "P:" + Password + ";;";
                    } else {
                        inputValue = "WIFI:T:WPA;S:" + SSID + ";" + "P:" + Password + ";;";
                    }
                if (SSID.equals("")) {
...
//                Toast.makeText(this, "Floating Action Button", Toast.LENGTH_SHORT).show();
            ...
            case R.id.fabsave:
                ...
                String result;
                try {
                    save = QRGSaver.save(savePath, SSIDText.getText().toString().trim(), bitmap, QRGContents.ImageType.IMAGE_JPEG);
